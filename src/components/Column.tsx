function Flute() {
  return <div className="bg-light border-l-2 border-border w-1.5 h-full"></div>;
}
  ...
  return (
    <div className="flex-none md:block hidden h-full relative mr-1 ml-0.5">
      ...
      <div className="flex h-full">
        <div className="border-border w-2 h-full"></div>
        <Flute />
        <Flute />
        <Flute />
        <Flute />
        ...
        <Flute />
        <Flute />
        <div className="border-l-2 border-border w-2 h-full"></div>
      </div>
