...
export default function Header() {
  return (
    <div className="md:p-4 px-8 md:px-8 border-b-2 border-border bg-light font-classical tracking-widest font-bold flex justify-center sm:justify-between items-center">
