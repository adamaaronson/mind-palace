...
export default function Header() {
  return (
    <div className="md:p-3 pt-1 md:pt-4 px-8! border-b-standard bg-light font-classical tracking-widest font-bold flex justify-center sm:justify-between items-center z-100">
