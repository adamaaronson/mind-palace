    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={`fixed w-full h-full max-w-screen max-h-screen top-0 left-0 flex justify-center items-center z-50 p-4 ${
            isOpen ? "block" : "hidden"
          }`}
        >
          <div
          ...
          ></div>
          <div
            className={`bg-light border-standard min-w-0 z-52 relative inset-shadow-scroll m-4 mt-12 md:mt-22 ${className}`}
          >
            ...
            <div className="p-4 px-8 overflow-scroll">
              <motion.div
                initial={{ height: 0 }}
                animate={{ height: "auto" }}
