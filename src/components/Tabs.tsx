    ...
    <div className="mx-4">
      <div className="flex flex-row items-end">
        {labels.map((label, index) => (
          <button
            className={`text-2xl font-bold p-2 px-4 border-2 border-taupe not-first:-ml-0.5 ${
              index === activeIndex
      ...
      {children.map((child, index) => (
        <div
          className={`-mt-0.5 p-4 px-8 mb-4 bg-light border-2 border-taupe overflow-hidden ${
